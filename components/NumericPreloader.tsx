...
export default function NumericPreloader({
  ...
  return (
    ...
    >
      <div
        className="inline-flex items-baseline gap-x-1 font-departure-mono tabular-nums text-[40px] leading-none tracking-wide [font-variant-numeric:slashed-zero] sm:gap-x-2 sm:text-[64px]"
        aria-hidden="true"
      >
